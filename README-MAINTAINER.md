...
Determine the upstream version (like `4.0.3`) and eventually update the
`package.json` file; the format is `4.0.3-pre`.
...
and fix them; assign them to a milestone (like `4.0.3`).
...
- add a new entry like _* v4.0.3_
- commit with a message like _prepare v4.0.3_
...
- `npm dist-tag add @micro-os-plus/architecture-synthetic-posix@4.0.3 latest`
- `npm dist-tag ls @micro-os-plus/architecture-synthetic-posix`
