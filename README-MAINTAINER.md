...
- name the file like `2020-12-19-architecture-synthetic-posix-v0-1-0-released.md`
- name the post like: **µOS++ architecture-synthetic-posix v0.1.0 released**
...
- `npm dist-tag add @micro-os-plus/architecture-synthetic-posix@0.1.0 latest`
- `npm dist-tag ls @@micro-os-plus/architecture-synthetic-posix`
...
- paste the release name like **µOS++ architecture-synthetic-posix v0.1.0 released**
