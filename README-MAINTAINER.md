...
Determine the upstream version (like `5.0.2`) and eventually update the
`package.json` file; the format is `5.0.2-pre`.
...
and fix them; assign them to a milestone (like `5.0.2`).
...
- add a new entry like _\* v5.0.2_
- commit with a message like _prepare v5.0.2_
...
- `npm dist-tag add @micro-os-plus/architecture-synthetic-posix@5.0.2 latest`
- `npm dist-tag ls @micro-os-plus/architecture-synthetic-posix`
