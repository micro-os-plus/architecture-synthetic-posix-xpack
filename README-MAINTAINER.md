...
- name the post like: **µOS++ architecture-synthetic-posix v3.0.0 released**
...
- `npm dist-tag add @micro-os-plus/architecture-synthetic-posix@3.0.0 latest`
- `npm dist-tag ls @@micro-os-plus/architecture-synthetic-posix`
...
- paste the release name like **µOS++ architecture-synthetic-posix v3.0.0 released**
