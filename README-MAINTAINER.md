...
- name the post like: **µOS++ architecture-synthetic-posix v1.1.0 released**
...
- `npm dist-tag add @micro-os-plus/architecture-synthetic-posix@1.1.0 latest`
- `npm dist-tag ls @@micro-os-plus/architecture-synthetic-posix`
...
- paste the release name like **µOS++ architecture-synthetic-posix v1.1.0 released**
